...
def run(engine):
    ...
    perftlist = [
        ...
        Perft('r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0', [48,2039,97862,4085603,193690690,8031647685]),
        Perft('8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0', [14,191,2812,43238,674624,11030083,178633661,3009794393]),
