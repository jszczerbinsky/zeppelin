...
try:
    ...
    NNUEInputTest(engine, 'r5k1/p4ppp/1pp4r/3p4/2PP2q1/3B1PP1/PPQ3K1/2R2R2 b - - 2 25')
    NNUEInputTest(engine, '8/2p2Qpk/8/p3p1B1/7p/2NPP1P1/4NP1P/1R2K2R b K - 1 23')
    NNUEInputTest(engine, 'r1bq1rk1/1ppp1ppp/2n2n2/p1b1p3/2P5/P1NP2P1/1P2PPBP/R1BQK1NR w KQ - 0 7')
    NNUEInputTest(engine, 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1')
    NNUEInputTest(engine, '8/2k5/4K1pp/p7/8/2N5/P1P3PP/8 b - - 0 32')
    NNUEInputTest(engine, '1r4k1/5p1p/p1p3p1/5P2/2pP4/2KB2q1/P3R3/5R2 w - - 0 36')
    NNUEInputTest(engine, 'r2q1rk1/ppp2ppp/8/3p3n/8/2PQPNb1/PP1N1PPP/R3K2R w KQ - 0 13')
    NNUEInputTest(engine, 'r2q1rk1/p1p2ppp/5n2/1pPp4/8/3QPNb1/PP1N1PPP/R3K2R w KQ b6 0 15')
    NNUEInputTest(engine, 'r2q1rk1/p1p2ppp/1P3n2/3p4/8/3QPNb1/PP1N1PPP/R3K2R b KQ - 0 15')
    NNUEInputTest(engine, 'r2q1rk1/pP3ppp/2p2n2/3p4/8/3QPNb1/PP1N1PPP/R3K2R b KQ - 0 16')
    NNUEInputTest(engine, 'rnbqkbnr/ppp5/8/8/8/8/PPPPP1pP/RNBQK2R b KQkq - 0 1')
    NNUEInputTest(engine, '3n3k/rPP5/1PP5/6bP/1K3p2/2p5/2R2BN1/4n3 w - - 0 1')
    NNUEInputTest(engine, '3n4/3K1bRp/2p5/2p2B2/6P1/P1b4Q/N3N3/n2k4 w - - 0 1')
    NNUEInputTest(engine, '4N1k1/1K2P2b/2B3nn/pP6/r3P3/5p2/p5P1/5N2 w - - 0 1')
    NNUEInputTest(engine, '8/P4pk1/PBp5/1q4P1/p3b1K1/n2p4/p7/1BN5 w - - 0 1')
    NNUEInputTest(engine, '8/1P1Q2Kb/4Rn2/n3P1P1/Pk1p4/8/1p3N1p/3B4 w - - 0 1')
    NNUEInputTest(engine, '8/3P1kN1/3Q2RP/1P4K1/7p/1p2p3/1RPp3p/7b w - - 0 1')
    NNUEInputTest(engine, '8/4K1p1/b2B2N1/3P1r2/p1pq1p2/n1QP4/4P2k/8 w - - 0 1')
    NNUEInputTest(engine, '7K/8/8/3k4/8/8/8/8 w - - 0 1')
    NNUEInputTest(engine, '5K2/8/8/8/8/8/7k/8 w - - 0 1')
    NNUEInputTest(engine, '8/7r/8/8/8/8/4k3/6K1 w - - 0 1')
    NNUEInputTest(engine, '3K4/6k1/8/N7/8/8/8/8 w - - 0 1')
    NNUEInputTest(engine, 'K5k1/8/8/8/8/8/b7/8 w - - 0 1')
    NNUEInputTest(engine, '8/B3K3/P5b1/8/4P1p1/1kb3q1/1p5p/8 w - - 0 1')
    NNUEInputTest(engine, '8/p7/2P3p1/1n6/4b3/P6k/P1P4P/3K4 w - - 0 1')
    NNUEInputTest(engine, '7K/1P2pR2/3B4/2p2bp1/8/2RP3k/8/8 w - - 0 1')
    NNUEInputTest(engine, '4n1B1/q2k1ppN/Q1Rrp2P/2P3P1/pP1n1PP1/2Br4/1pp3PK/2bN4 w - - 0 1')
    NNUEInputTest(engine, '4n2K/p1P1kqR1/2PrNpP1/1P5B/QPPR1Ppb/1Np3P1/2p3rp/8 w - - 0 1')
    NNUEInputTest(engine, '4NB2/3p3B/Npk1p1P1/b1P1P1PP/3nP1P1/p1p5/K1Q1brRR/n3q3 w - - 0 1')
    NNUEInputTest(engine, '1r6/k4p1B/1p2Np2/PPR1pPpp/1P2r1P1/QP2PNb1/3B1pp1/2K4n w - - 0 1')
    NNUEInputTest(engine, 'r2qk2r/p1p1bppp/2np1B2/4N2b/P1B1P1n1/3P3P/1pP2P2/R2Q1RK1 b kq - 1 13')
    NNUEInputTest(engine, '8/8/8/2k5/2pP4/8/B7/4K3 b - d3 0 3')
    NNUEInputTest(engine, 'r3k2r/1b4bq/8/8/8/8/7B/R2K3R b kq - 1 1')
    NNUEInputTest(engine, 'r3k2r/1b5q/8/8/8/2b5/7B/R2K3R w kq - 2 2')
    ...
    GenMovesTest(engine, '2K2r2/4P3/8/8/8/8/8/3k4 w - - 0 1')
    GenMovesTest(engine, 'rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1')
    GenMovesTest(engine, '2r2rk1/4qp1p/2p2np1/3p2N1/1P6/P2QP1P1/1P3PP1/1K1R3R w - - 3 23')
    GenMovesTest(engine, '8/8/8/3K4/2N5/3k4/1Q5P/8 b - - 4 48')
    GenMovesTest(engine, 'r5k1/p4ppp/1pp4r/3p4/2PP2q1/3B1PP1/PPQ3K1/2R2R2 b - - 2 25')
    GenMovesTest(engine, '8/2p2Qpk/8/p3p1B1/7p/2NPP1P1/4NP1P/1R2K2R b K - 1 23')
    GenMovesTest(engine, 'r1bq1rk1/1ppp1ppp/2n2n2/p1b1p3/2P5/P1NP2P1/1P2PPBP/R1BQK1NR w KQ - 0 7')
    GenMovesTest(engine, 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1')
    GenMovesTest(engine, '8/2k5/4K1pp/p7/8/2N5/P1P3PP/8 b - - 0 32')
    GenMovesTest(engine, '1r4k1/5p1p/p1p3p1/5P2/2pP4/2KB2q1/P3R3/5R2 w - - 0 36')
    GenMovesTest(engine, 'r2q1rk1/ppp2ppp/8/3p3n/8/2PQPNb1/PP1N1PPP/R3K2R w KQ - 0 13')
    GenMovesTest(engine, 'r2q1rk1/p1p2ppp/5n2/1pPp4/8/3QPNb1/PP1N1PPP/R3K2R w KQ b6 0 15')
    GenMovesTest(engine, 'r2q1rk1/p1p2ppp/1P3n2/3p4/8/3QPNb1/PP1N1PPP/R3K2R b KQ - 0 15')
    GenMovesTest(engine, 'r2q1rk1/pP3ppp/2p2n2/3p4/8/3QPNb1/PP1N1PPP/R3K2R b KQ - 0 16')
    GenMovesTest(engine, 'rnbqkbnr/ppp5/8/8/8/8/PPPPP1pP/RNBQK2R b KQkq - 0 1')
    GenMovesTest(engine, '3n3k/rPP5/1PP5/6bP/1K3p2/2p5/2R2BN1/4n3 w - - 0 1')
    GenMovesTest(engine, '3n4/3K1bRp/2p5/2p2B2/6P1/P1b4Q/N3N3/n2k4 w - - 0 1')
    GenMovesTest(engine, '4N1k1/1K2P2b/2B3nn/pP6/r3P3/5p2/p5P1/5N2 w - - 0 1')
    GenMovesTest(engine, '8/P4pk1/PBp5/1q4P1/p3b1K1/n2p4/p7/1BN5 w - - 0 1')
    GenMovesTest(engine, '8/1P1Q2Kb/4Rn2/n3P1P1/Pk1p4/8/1p3N1p/3B4 w - - 0 1')
    GenMovesTest(engine, '8/3P1kN1/3Q2RP/1P4K1/7p/1p2p3/1RPp3p/7b w - - 0 1')
    GenMovesTest(engine, '8/4K1p1/b2B2N1/3P1r2/p1pq1p2/n1QP4/4P2k/8 w - - 0 1')
    GenMovesTest(engine, '7K/8/8/3k4/8/8/8/8 w - - 0 1')
    GenMovesTest(engine, '5K2/8/8/8/8/8/7k/8 w - - 0 1')
    GenMovesTest(engine, '8/7r/8/8/8/8/4k3/6K1 w - - 0 1')
    GenMovesTest(engine, '3K4/6k1/8/N7/8/8/8/8 w - - 0 1')
    GenMovesTest(engine, 'K5k1/8/8/8/8/8/b7/8 w - - 0 1')
    GenMovesTest(engine, '8/B3K3/P5b1/8/4P1p1/1kb3q1/1p5p/8 w - - 0 1')
    GenMovesTest(engine, '8/p7/2P3p1/1n6/4b3/P6k/P1P4P/3K4 w - - 0 1')
    GenMovesTest(engine, '7K/1P2pR2/3B4/2p2bp1/8/2RP3k/8/8 w - - 0 1')
    GenMovesTest(engine, '4n1B1/q2k1ppN/Q1Rrp2P/2P3P1/pP1n1PP1/2Br4/1pp3PK/2bN4 w - - 0 1')
    GenMovesTest(engine, '4n2K/p1P1kqR1/2PrNpP1/1P5B/QPPR1Ppb/1Np3P1/2p3rp/8 w - - 0 1')
    GenMovesTest(engine, '4NB2/3p3B/Npk1p1P1/b1P1P1PP/3nP1P1/p1p5/K1Q1brRR/n3q3 w - - 0 1')
    GenMovesTest(engine, '1r6/k4p1B/1p2Np2/PPR1pPpp/1P2r1P1/QP2PNb1/3B1pp1/2K4n w - - 0 1')
    GenMovesTest(engine, 'r2qk2r/p1p1bppp/2np1B2/4N2b/P1B1P1n1/3P3P/1pP2P2/R2Q1RK1 b kq - 1 13')
    GenMovesTest(engine, '8/8/8/2k5/2pP4/8/B7/4K3 b - d3 0 3')
    GenMovesTest(engine, 'r3k2r/1b4bq/8/8/8/8/7B/R2K3R b kq - 1 1')
    GenMovesTest(engine, 'r3k2r/1b5q/8/8/8/2b5/7B/R2K3R w kq - 2 2')
